...
if __name__ == '__main__':
    ...
    # Generate documents
    document_paths = [
        os.path.join(config.PREFECT_CONTEXTS_DIRECTORY, file_name)
        for file_name in os.listdir(config.PREFECT_CONTEXTS_DIRECTORY)
    ]
    loaders = [
        PyPDFLoader(document_path) for document_path in document_paths
    ]
    documents = []
